<?php
// Heading
$_['heading_title'] = '01. Предложения продуктов';
...
$_['label_attr'] = 'Префиксы атрибутов:';
$_['entry_prefix_attr'] = 'Укажите префикс:';

$_['entry_view_only_master'] = 'Отображать только основной товар:';
